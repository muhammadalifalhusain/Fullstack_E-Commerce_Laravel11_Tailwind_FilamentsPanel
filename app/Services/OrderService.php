...
class OrderService
{
    ...
    public function __construct(PromoCodeRepositoryInterface $promoCodeRepositoryy,
    ...
    ShoeRepositoryInterface $shoeRepository)
    {
        ...
        $this->promoCodeRepository = $promoCodeRepositoryy;
    ...
    public function applyPromoCode(string $code, int $subTotalAmount)
    {
        ...
        return ['erorr' => 'Kode Promo Tidak Tersedia'];
    }
